...
{
      \textbf{a practical introduction}
}

\author[Charles I. Saidu]
{      Charles Isah Saidu \\
      {\ttfamily charles.i.saidu@gmail.com}
}
...
\begin{frame}{Introduction}{What is it?}
%-------------------------------------------------------
  \begin{figure}\label{fig1:active_learning}
\caption{Active Learning \cite{Settles2010}}
  \includegraphics[width = 8cm, height=5cm]{active_learning}
  \end{figure}
  \begin{itemize}
    \item<1-> The learning algorithm chooses the samples to be labeled  image for any purposes.
    \item<2-> Goal/(s): To reduce the number of labeled examples needed for learning.
  \end{itemize}
\end{frame}
\subsection{Informativeness}
\begin{frame}{Informativeness}
  \begin{itemize}
  \item How does the algorithm know what sample to select a.k.a Querying Techniques?
\end{itemize}
\end{frame}{Informativeness}
